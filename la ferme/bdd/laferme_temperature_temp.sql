...
--
-- Dumping data for table `temperature_temp`
--

LOCK TABLES `temperature_temp` WRITE;
/*!40000 ALTER TABLE `temperature_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `temperature_temp` ENABLE KEYS */;
UNLOCK TABLES;
